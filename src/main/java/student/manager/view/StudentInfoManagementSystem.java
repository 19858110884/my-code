...
public class StudentInfoManagementSystem extends JFrame {
    ...
    public StudentInfoManagementSystem() {
        ...
        tabbedPane.addTab("信息录入", splitPane);

        // 信息信息面板
        JPanel studentInfoPanel = createStudentInfoPanel();
        tabbedPane.addTab("学生信息", studentInfoPanel);
        // 成绩信息面板
        JPanel scoreInfoPanel = createScoreInfoPanel();


        tabbedPane.addTab("成绩信息", scoreInfoPanel);
        add(tabbedPane);
    ...
    private JPanel createScoreInfoPanel() {
        ...
        JLabel courseNameLabel = new JLabel("课程:");
        courseNameField = new JTextField();
        scoreSearchButton = new JButton("搜索");
        ...
        deleteScoreButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    JOptionPane.showMessageDialog(null, "请选择要删除的成绩");
                    return;
                }
                // 获取选中行的号
        ...
        // 中间表格展示成绩信息
        // 设置表头
        scoreTableModel = new DefaultTableModel(new String[]{"编号", "学号", "姓名", "课程", "成绩"}, 0);
        // 设置表格
...
//        searchPanel.add(editStudentButton);
        ...
        // 设置表头
        tableModel = new DefaultTableModel(new String[]{"学号", "姓名", "班级", "出生日期", "籍贯", "性别"}, 0);
        // 设置表格
        ...
        // 下方为统计面板
        signScoreButton = new JButton("录入成绩");
        signScoreButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow == -1) {
                    JOptionPane.showMessageDialog(null, "请选择要录入成绩的学生");
                    return;
                }
                // 获取选中行的学号
        ...
        editStudentButton = new JButton("修改学生信息");
        // 修改学生按钮的监听器
        ...
        lookAgeButton = new JButton("查看年龄分布");
        lookHomeTownButton = new JButton("查看籍贯分布");
        // 查看年龄分布按钮的监听器
        lookAgeButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // 弹出新窗口显示年龄分布
                JFrame jFrame = new JFrame("年龄分布");
...
//                    student.getBirthday()截取前四位年份
    ...
    private void createEditStudentJFrame(String id) {
        ...
        JLabel classLabel = new JLabel("所在班级:");
        ...
        maleRadio.setActionCommand("男");
        JRadioButton femaleRadio = new JRadioButton("女");
        femaleRadio.setActionCommand("女");
    ...
    private JPanel createClassPanel() {
        ...
        JLabel startTimeLabel = new JLabel("班级开始时间:");
        ...
        addClassInfoButton = new JButton("添加班级");
        // 添加班级按钮的监听器
